...
export default function Playlist() {
  ...
  const tracks = [
    { title: "INTRO", artist: "SAJA BOYS", audio: "/song/saja boys intro.mp3" },
    { title: "FIRE FLOW", artist: "SAJA BOYS", audio: "/song/Fire Flow.mp3" , disabled: true  },
    { title: "STREET LEGENDS", artist: "SAJA BOYS", audio: "/song/Street Legends.mp3", disabled: true },
    { title: "MONEY MOVES", artist: "SAJA BOYS", audio: "/song/Money Moves.mp3", disabled: true },
    
    { title: "HUSTLE HARD", artist: "SAJA BOYS", audio: "/song/Hustle Hard.mp3", disabled: true },
    { title: "CITY LIGHTS", artist: "SAJA BOYS", audio: "/song/City Lights.mp3", disabled: true },
    { title: "BROTHERHOOD", artist: "SAJA BOYS", audio: "/song/Brotherhood.mp3", disabled: true },
    { title: "RISE UP", artist: "SAJA BOYS", audio: "/song/Rise Up.mp3", disabled: true },
    { title: "VICTORY ANTHEM", artist: "SAJA BOYS", audio: "/song/Victory Anthem.mp3", disabled: true },
    { title: "CELEBRATION", artist: "SAJA BOYS", audio: "/song/Celebration.mp3", disabled: true },
    { title: "LEGACY", artist: "SAJA BOYS", audio: "/song/Legacy.mp3", disabled: true },
    { title: "OUTRO", artist: "SAJA BOYS", audio: "/song/Outro.mp3", disabled: true }
  ]
  ...
  return (
    <div className="min-h-[105vh] bg-[#0d0d0d] text-[#f2f2f2] overflow-hidden relative">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 right-0 flex justify-between items-center h-[700px] pointer-events-none overflow-hidden" style={{ marginTop: '10px' }}>
          {/* Vinyle gauche */}
        ...
        <main className="flex items-center px-8 pb-10 mt-8">
